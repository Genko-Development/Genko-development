    ...
    run: async(client, message, args) => {
        ...
        fetch("https://finance.yahoo.com/quote/TSLA?p=TSLA")
            ...
            .then(html => {
                ...
                const description = $("meta[property='og:description']")[0] || $("meta[name='twitter:description']")[0]
                const image = $("meta[property='og:image']")[0] || $("meta[name='twitter:image']")[0]
                const share = $("fin-streamer[data-test='qsp-price']")[0] // Try get something that doesn't exists

                // const share = cheerio.load('.Fw(b)');
                console.log(share ? share.attribs.value : "no title")
